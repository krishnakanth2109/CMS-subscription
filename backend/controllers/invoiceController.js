...
export const createInvoice = async (req, res) => {
  try {
    const tenantOwnerId = req.user.role === 'manager' ? req.user._id : req.user.tenantOwnerId;
...
export const getInvoices = async (req, res) => {
  try {
    ...
    if (req.user.role === 'recruiter') {
      ...
      query.tenantOwnerId = tenantOwnerId;
    }
...
export const getInvoiceById = async (req, res) => {
  try {
    ...
    if (req.user.role === 'recruiter') {
      ...
      if (String(invoice.tenantOwnerId) !== String(tenantOwnerId)) {
